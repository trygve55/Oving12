...
Programmer som \flqq{}zip\frqq{} bruker Lempel-Ziv for å komprimere,
...
\item Dere må lage programmene selv, ikke noe \flqq{}cut \& paste\frqq{}
fra nettet. Grupper som ikke kan forklare detaljer i programmet sitt,
får ikke godkjent denne oppgaven. Det er mye å lære av å gjøre en
slik oppgave, som en ikke får med seg med \flqq{}cut \& paste\frqq{}.
...
Datatypen \flqq{}long\frqq{} er på 64 bit. Ingen tegn vil trenge
lenger Huffmankode enn det. (Det kan vises at nå man komprimerer en
fil på 2.7GB, trenger ingen tegn kodes med mer enn 44 bit.) \flqq{}long\frqq{}
...
an å skrive \flqq{}en halv byte\frqq{} til fil, man må i det minste
samle opp bits til man har en hel byte. Det kan være lurt å lage en
